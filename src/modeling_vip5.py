# force using local transformers
import sys
sys.path.insert(0, "/scratch/guowei/Code/VIP5/transformers")
...
class T5DenseGatedGeluDense(nn.Module):
    ...
    def forward(self, hidden_states):
        hidden_gelu = torch.mul(self.wi_0(hidden_states), F.gelu(self.wi_1(hidden_states)))
        hidden_states = self.dropout(hidden_gelu)
        hidden_states = self.wo(hidden_states)
        return hidden_states
